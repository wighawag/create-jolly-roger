...
- fe3a042: Rebuild on [offshoot](https://github.com/wighawag/offshoot): scaffolded projects can now pull in template improvements later.
...
- 996a3b8: Initial release: scaffold full-stack onchain apps from the jolly-roger template via degit, with project name substitution and git init.
